...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('teams_member', 'phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Member.phone'
        db.delete_column('teams_member', 'phone')
