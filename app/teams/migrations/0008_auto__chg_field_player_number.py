...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('teams_player', 'number', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Player.number'
        db.alter_column('teams_player', 'number', self.gf('django.db.models.fields.IntegerField')(default=10))
