...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('teams_player', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Team'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Player.team'
        db.alter_column('teams_player', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['teams.Team']))
