...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Step.duration'
        db.add_column('workouts_step', 'duration', self.gf('django.db.models.fields.IntegerField')(default=15, null=True, blank=True), keep_default=False)

        # Adding field 'Activity.duration'
        db.add_column('workouts_activity', 'duration', self.gf('django.db.models.fields.IntegerField')(default=15, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Step.duration'
        db.delete_column('workouts_step', 'duration')

        # Deleting field 'Activity.duration'
        db.delete_column('workouts_activity', 'duration')
