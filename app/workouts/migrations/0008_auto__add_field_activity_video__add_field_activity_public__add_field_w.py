...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Activity.video'
        db.add_column('workouts_activity', 'video', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Activity.public'
        db.add_column('workouts_activity', 'public', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Workout.public'
        db.add_column('workouts_workout', 'public', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Activity.video'
        db.delete_column('workouts_activity', 'video')

        # Deleting field 'Activity.public'
        db.delete_column('workouts_activity', 'public')

        # Deleting field 'Workout.public'
        db.delete_column('workouts_workout', 'public')
