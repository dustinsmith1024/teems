...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Practice.open'
        db.add_column('workouts_practice', 'open', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Practice.open'
        db.delete_column('workouts_practice', 'open')
