...
urlpatterns = patterns('workouts.views',
    ...
    url(r'^community/activities/', 'community_activities', name='community_activities'),
    url(r'^community/workouts/', 'community_workouts', name='community_workouts'),
    ...
    url(r'^all/', 'public_workouts', name='all_workouts'),
    url(r'^team/', 'team_workouts', name='team_workouts'),
