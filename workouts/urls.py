...
urlpatterns = patterns('workouts.views',
    ...
    url(r'^activities/(?P<activity_id>\d+)/update/$', 'edit_activity', name='edit_activity'),
    url(r'^activities/(?P<activity_id>\d+)/$', 'activity', name='activity'),
    url(r'^activities/', 'activities', name='activities'),
    url(r'^individuals/(?P<individual_id>\d+)/update/$', 'edit_individual', name='edit_individual'),
