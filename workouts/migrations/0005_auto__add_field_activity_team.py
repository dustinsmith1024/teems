...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Activity.team'
        db.add_column('workouts_activity', 'team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Team'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Activity.team'
        db.delete_column('workouts_activity', 'team_id')
